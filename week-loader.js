...
(async function () {
    ...
    if (!window.WEEK_ID) console.log('📅 週次シナリオ未検出。内蔵データ(route-data.js等)で起動します。');

    // --- 準備完了 → 本体を起動 ---
    const s = document.createElement('script');
    s.src = 'app.js?v=6.0.0';
    s.onload = () => { if (location.search.includes('edit=1')) { const e = document.createElement('script'); e.src = 'editor.js?v=6.0.0'; document.body.appendChild(e); } };
